...
type PetFunc func(context.Context, *generate.PetMutation) (generate.Value, error)

// Mutate calls f(ctx, m).
func (f PetFunc) Mutate(ctx context.Context, m generate.Mutation) (generate.Value, error) {
	if mv, ok := m.(*generate.PetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generate.PetMutation", m)
}
