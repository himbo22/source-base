...
func (_c *PetCreate) SetPublicID(v string) *PetCreate {
	_c.mutation.SetPublicID(v)
	return _c
}

// SetNillablePublicID sets the "public_id" field if the given value is not nil.
func (_c *PetCreate) SetNillablePublicID(v *string) *PetCreate {
	if v != nil {
		_c.SetPublicID(*v)
	}
	return _c
...
func (_c *PetCreate) SetUserID(v uuid.UUID) *PetCreate {
...
func (_c *PetCreate) check() error {
	if _, ok := _c.mutation.PublicID(); !ok {
		return &ValidationError{Name: "public_id", err: errors.New(`generate: missing required field "Pet.public_id"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generate: missing required field "Pet.created_at"`)}
	}
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generate: missing required field "Pet.updated_at"`)}
	}
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`generate: missing required field "Pet.name"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`generate: missing required field "Pet.user_id"`)}
	}
	if len(_c.mutation.OwnerIDs()) == 0 {
		return &ValidationError{Name: "owner", err: errors.New(`generate: missing required edge "Pet.owner"`)}
	}
	return nil
}
...
func (_c *PetCreate) createSpec() (*Pet, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.PublicID(); ok {
		_spec.SetField(pet.FieldPublicID, field.TypeString, value)
