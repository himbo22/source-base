...
func (_c *UserCreate) check() error {
	if _, ok := _c.mutation.PublicID(); !ok {
		return &ValidationError{Name: "public_id", err: errors.New(`generate: missing required field "User.public_id"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
	...
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`generate: missing required field "User.name"`)}
	}
	if _, ok := _c.mutation.Email(); !ok {
		return &ValidationError{Name: "email", err: errors.New(`generate: missing required field "User.email"`)}
	}
	return nil
}
